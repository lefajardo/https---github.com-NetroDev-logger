...
namespace NetroLogger_WorkerRole
{
    ...
    public class logStagingDailyAzTbl : TableServiceEntity
    {
        /*
    ...
    public class logStagingAzTbl : TableServiceEntity
    {
        /*
    ...
    public class UploadedLogFiles : TableServiceEntity
    {
    ...
    public class logBatchesAzTbl : TableServiceEntity
    {
        /*
    ...
    public class logErrorssAzTbl : TableServiceEntity
    {
        /*
    ...
    public class logFilesAzTbl : TableServiceEntity
    {
        /*
    ...
    public class logFilesNOPROCESSAzTbl : TableServiceEntity
    {
        /*
    ...
    public class logFilesRollUpAzTbl : TableServiceEntity
    {
        /*
    ...
    public class logFilesHourlyRollUpAzTbl : TableServiceEntity
    {
        /*
    ...
    public class logFilesHourlyRollUpAzTbl2 : TableServiceEntity
    {
