...
namespace NetroLogger_WorkerRole
{
	...
	"MF"};
        ...
        //2011-12-15. Lester. New constructor to get the database contents from the 
        //embedded resource file, to be used in azure deployment
        public LookupService( )            
        {
            try
            {
                ...
                //string fileContents = NetroLogger_WorkerRole.
                //Properties.Resources.
                var stream  = assembly.GetManifestResourceStream("NetroLoggerWorker.geodata.GeoLiteCity.dat");
                this.file = (UnmanagedMemoryStream )stream;
                //StreamReader sr = new StreamReader(stream1);
                //string q = sr.ReadToEnd();


                //byte[] a = System.Text.Encoding.GetEncoding("iso-8859-1").GetBytes(q);
                //this.file   = new System.IO.MemoryStream(a);
                
                /*
                using (var stream1 = assembly.GetManifestResourceStream("NetroLogger_WorkerRole.geodata.GeoLiteCityv6.dat"))
                {
                    //this.file = (FileStream)stream;
                    StreamReader sr = new StreamReader(stream1);
                  //  MemoryStream  ms = sr.ReadToEnd();
            ...
            {
                Console.Write("cannot open resource file \n");
            }
        }
