...
<serviceModel xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xsd="http://www.w3.org/2001/XMLSchema" name="LoggerWorker2016" generation="1" functional="0" release="0" Id="5c219fbd-19d5-4a9c-9035-7dcbbd981e78" dslVersion="1.2.0.0" xmlns="http://schemas.microsoft.com/dsltools/RDSM">
  <groups>
    <group name="LoggerWorker2016Group" generation="1" functional="0" release="0">
      ...
      <components>
        <groupHascomponents>
          <role name="WorkerRole1" generation="1" functional="0" release="0" software="C:\netro\LoggerWorker2016\LoggerWorker2016\csx\Debug\roles\WorkerRole1" entryPoint="base\x64\WaHostBootstrapper.exe" parameters="base\x64\WaWorkerHost.exe " memIndex="-1" hostingEnvironment="consoleroleadmin" hostingEnvironmentVersion="2">
            <componentports>
  ...
  <implements>
    <implementation Id="40b36dac-93a6-4144-b692-a5c2e9a41d8b" ref="Microsoft.RedDog.Contract\ServiceContract\LoggerWorker2016Contract@ServiceDefinition">
      <interfacereferences>
        <interfaceReference Id="a8de1d05-a9d5-4c05-849b-e3475d0cff6f" ref="Microsoft.RedDog.Contract\Interface\WorkerRole1:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput@ServiceDefinition">
          <inPort>
            <inPortMoniker name="/LoggerWorker2016/LoggerWorker2016Group/WorkerRole1:Microsoft.WindowsAzure.Plugins.RemoteForwarder.RdpInput" />
          </inPort>
        </interfaceReference>
